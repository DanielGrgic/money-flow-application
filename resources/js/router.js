...
const routes = [
  ...
  },
  {
    ...
    beforeEnter: auth,
    component: () => import('@/views/pages/change-password/index')
  },
  {
    path: '/delete-account',
    name: 'delete-account',
    beforeEnter: auth,
    component: () => import('@/views/pages/delete-account/index')
  },
  {
    path: '/account-statement',
    name: 'account-statement',
    beforeEnter: auth,
    component: () => import('@/views/pages/account-statement/index')
  },
  {
    path: '*',
